  ...
  return (
    <div id="presentation" className="presentation">
      ...
      <p className="presentation-p">
        ...
        Ainsi que les jeux vidéos mais aussi coder par simple plaisir de découvrir de nouvelles fonctionnalités.
        Je suis aussi intéressé par les IA et le machine learning.
      </p>
      <p className="presentation-p">
        Je fais de la photo dans les fêtes foraines et parc (avec gestion de pages facebook).
      </p>
      <p className="presentation-p">
        Je n'aime pas me mettre en avant, mais mes qualités selon moi seraient d'etre patient, à l'écoute et extrèment curieux ( je voudrais tout faire et tout voir !)
      </p>
    </div>
  );
}
