...
function SocialMedia() {
  return (
    <div className="socialmedia">
      <p className="socialmedia-p">Mes réseaux</p>
      ...
      <a className="socialmedia-a" href="../cv/cv_fred_meziere.pdf" target="_blank"><img className="socialmedia-img" src="../logo/cv.png" alt="Logo cv" /></a>
    </div>
  );
}
